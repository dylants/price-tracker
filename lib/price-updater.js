...
function PriceUpdater() {
                ...
                function(whilstCallback) {
                    ...
                    async.waterfall([
                        ...
                        function(outboundPrices, inboundPrices, waterfallCallback) {
                            ...
                            console.log();
                            console.log("inbound prices");
                            for (i = 0; i < inboundPrices.length; i++) {
                                console.log(inboundPrices[i]);
                            }
                            console.log();
                            console.log("outbound prices");
                            for (i = 0; i < outboundPrices.length; i++) {
                                console.log(outboundPrices[i]);
                            }
    ...
    function parseDateAndPriceForFlights(outboundPricesInput, inboundPricesInput,
        trackedFlight, callback) {

                                ...
                                browser.visit("http://www.southwest.com", function() {
                                    ...
                                    browser.pressButton("Search", function() {
                                        ...
                                        browser.clickLink(".shortcutNotification a", function() {
                                            ...
                                            outboundPrices = browser.text(".outboundCalendar table");
                                            inboundPrices = browser.text(".returnCalendar table");

                                            waterfallCallback(null, outboundPrices, inboundPrices);
                                        });
                                    });
                                });
                            }
                        },
                        function(outboundPricesString, inboundPricesString, waterfallCallback) {
                            ...
                            if (trackedFlight.airline === "southwest") {
                                ...
                                // pull the date and price out of the outbound prices string
                                datePricePairs = outboundPricesString.match(regex);
                                for (i = 0; i < datePricePairs.length; i++) {
                                    datePricePair = datePricePairs[i];

                                    // separate out the date from the price
                                    datePricePair = datePricePair.split(" ");
                                    date = datePricePair[0];
                                    price = datePricePair[1];

                                    // format the date
                                    // TODO remove out hard coded month and year
                                    date = moment("01/" + date + "/2014");

                                    console.log("date: " + date.format("MM/DD/YYYY"));
                                    console.log("price: " + price);

                                    // add it to our outbound prices list
                                    outboundPrices.push({
                                        price: price,
                                        date: date.toDate()
                                    });
                                ...
                                // pull the date and price out of the outbound prices string
                                datePricePairs = inboundPricesString.match(regex);
                                for (i = 0; i < datePricePairs.length; i++) {
                                    datePricePair = datePricePairs[i];
